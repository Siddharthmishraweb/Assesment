...
export default function CustomerDetails() {
  ...
  const { data: insightsSummary, isLoading: insightsLoading } = useCustomerInsightsSummary(customerId || '', 90)
  const { data: customerStats, isLoading: statsLoading, error: statsError } = useCustomerStats(customerId || '')
